    ...
    <div class="bg-linear-to-b from-violet-600/[.15] via-transparent">
      <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8">
        ...
        <div class="max-w-3xl text-center mx-auto">
          <h3 class="block font-medium text-gray-200 text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
        ...
        <div class="max-w-3xl text-center mx-auto">
          <p class="text-lg text-gray-400">ci4 with shield and tailwinds will take care of your heavy lifting.</p>
        </div>
